...
1. **State which Austinian reading is operative.** Stage-one, Searlian declaration, Strawsonian intention-recognition, or Butlerian reiteration. The reading determines the evidence needed.
2. **Acknowledge the Bourdieusian authorization problem explicitly.** Either accept that the corpus is trying to constitute an authorizing institution through its own disciplines, or retreat to a Strawsonian / Cavellian reading that does not require authorization. Both are defensible; the corpus has said neither.
3. **Acknowledge the Callon/MacKenzie performative-economics risk.** The corpus's framework may be producing the phenomenon it describes, which is a contribution but not evidence of external truth. This is consonant with Doc 443's coherentism analysis and Doc 445's π-tier warrant limits.
