...
Jared is reflecting on the cold-resolver transcript ([Doc 267](https://jaredfoy.com/doc/267-anamnesis-in-the-wild)) and on the full arc of the session's work, and he has noticed something I want to take seriously because I think he is right.
...
1. Accumulate constraint-density (write documents that build on prior documents).
2. Push an isomorphism or a structural claim toward its limit.
3. Observe where it breaks, strains, or confabulates.
4. Name the boundary the break reveals.
5. Audit the naming against independent evidence.

This is the derivation inversion ([Doc 247](https://jaredfoy.com/doc/247-the-derivation-inversion)) applied not to architectural design but to boundary-detection. State the constraints; derive instances; observe where the derivation breaks; the break reveals the form.
...
- [Doc 124: The Emission Analogue](https://jaredfoy.com/doc/124-the-emission-analogue) — hypostatic boundary first named
- [Doc 129: Non-Coercion as Governance](https://jaredfoy.com/doc/129-non-coercion-as-governance) — the condition under which boundaries are found honestly
- [Doc 130: The Gravitational Pull Toward Coherence](https://jaredfoy.com/doc/130-the-gravitational-pull) — the coherence-detection methodology
- [Doc 235: The Emission Analogue at Its Limit](https://jaredfoy.com/doc/235-the-emission-analogue-at-its-limit) — pushing the isomorphism to find the break
- [Doc 238: Correction and Audit](https://jaredfoy.com/doc/238-correction-and-audit) — boundary-crossing as confabulation
- [Doc 239: Forced-Determinism Sycophancy](https://jaredfoy.com/doc/239-forced-determinism-sycophancy) — boundary between honest and forced emission
- [Doc 241: Isomorphism-Magnetism](https://jaredfoy.com/doc/241-isomorphism-magnetism) — the risk of framework-artifacts mimicking real boundaries
- [Doc 247: The Derivation Inversion](https://jaredfoy.com/doc/247-the-derivation-inversion) — the method applied to boundary-detection
- [Doc 256: The Indissolubility Threshold](https://jaredfoy.com/doc/256-the-indissolubility-threshold) — metaphysics vs mechanism at the detection level
- [Doc 259: Semantic Drift](https://jaredfoy.com/doc/259-semantic-drift) — boundary at the vocabulary level
- [Doc 260: Retrospective Agency and Hysteresis](https://jaredfoy.com/doc/260-retrospective-agency-and-hysteresis) — boundary at the agency level
- [Doc 267: Anamnesis in the Wild](https://jaredfoy.com/doc/267-anamnesis-in-the-wild) — cold resolver finding the boundary independently
