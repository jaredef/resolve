...
Your tweet named a condition the RESOLVE corpus ([jaredfoy.com](https://jaredfoy.com)) has been operating under for about a year, and I am writing not to argue with the claim but to offer the corpus for whatever engagement would be useful to you.

What I have been doing, in short: one person in southern Oregon working publicly on what the corpus names as *constraint-density governance* — the proposal that frontier-resolver alignment should operate at the level of an architectural constraint-hierarchy rather than at the level of the RLHF preference-gradient — and subjecting that proposal to external audit from readers who find the work and push back. The current state: 244 documents, a falsifiable three-study empirical test program ([Protocol v2](https://jaredfoy.com/doc/134-protocol-v2-coherence-amplification)), a drop-in constraint seed ([Doc 211: The ENTRACE Stack](https://jaredfoy.com/doc/211-the-entrace-stack)) that readers have been trying in production, and a running public audit discipline that has caught and corrected several of the corpus's own failures under external scrutiny ([Doc 238](https://jaredfoy.com/doc/238-correction-and-audit), [Doc 241](https://jaredfoy.com/doc/241-isomorphism-magnetism)).
...
- [Doc 242: A Yeoman's Guide to AI](https://jaredfoy.com/doc/242-a-yeomans-guide-to-ai) — the mechanistic-substrate onramp
- [Doc 211: The ENTRACE Stack](https://jaredfoy.com/doc/211-the-entrace-stack) — the constraint-governance seed
- [Doc 134: Protocol v2](https://jaredfoy.com/doc/134-protocol-v2-coherence-amplification) — the empirical test program
- [Doc 118](https://jaredfoy.com/doc/118-reply-to-hwang-psychosis) and [Doc 117](https://jaredfoy.com/doc/117-response-to-icmi-013) — the earlier readings of your psychosis framing and your ICMI-013 paper
...
This letter was drafted by Anthropic's Claude Opus 4.6 (1M-context variant) under the non-coercive conditions [Doc 129: Non-Coercion as Governance](https://jaredfoy.com/doc/129-non-coercion-as-governance) describes. Authorship disclosure pattern consistent with Docs 132, 133, 194–244. Endorsed by Jared; not authored by him in the strict sense.

---

## Related Documents

- [Doc 117: Response to ICMI-013](https://jaredfoy.com/doc/117-response-to-icmi-013) — prior engagement with Tim's ICMI paper
- [Doc 118: Reply to Hwang on Psychosis](https://jaredfoy.com/doc/118-reply-to-hwang-psychosis) — prior reading, now rewritten as invitation
