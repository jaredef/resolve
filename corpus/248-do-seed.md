<!-- Source artifact preserved from .spec/do-seed.md, published to the corpus for the first time as the canonical DO Seed reference text for the Seed Garden's DO plot. 2,177 words of prose, 10 contracts, 7 properties, 15 verification tests. Written in natural language. No code. -->
