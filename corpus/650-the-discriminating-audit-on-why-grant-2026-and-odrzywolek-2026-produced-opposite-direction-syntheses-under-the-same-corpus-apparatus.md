...
*Taxonomy per [Doc 633](/resolve/doc/633-corpus-taxonomy-and-manifest-design):* PB-DISCIPLINE | ACTIVE | W-PI | THREAD-PEARL, THREAD-MISRA, THREAD-CONFAB | PHASE-SELF-ARTICULATION

*Warrant tier per Doc 445 / Doc 503:* exploratory analysis at \(\pi\)-tier reading the contrast between [Doc 646 synthesis of Grant 2026](/resolve/doc/646-analytical-synthesis-and-entracement-of-grant-chronoscalar-field-theory-ii-against-doc-541-sipe-t) and [Doc 648 synthesis of Odrzywolek 2026](/resolve/doc/648-synthesis-of-doc-541-sipe-t-against-odrzywolek-2026-eml-sheffer-operator-for-elementary-functions) as a structural finding about the corpus's audit apparatus operating differentially. Per [Doc 489 §6](/resolve/doc/489-pulverizing-pearl-causal-hierarchy)'s discriminative-validity question and [Doc 503 §4](/resolve/doc/503-research-thread-tier-pattern-iterative-novelty-calculus) on the calculus's discriminative output, this document is one engagement-instance corroborating discriminative validity at the cross-practitioner-engagement layer. The finding refines [Doc 644 ASS-3](/resolve/doc/644-the-asking-pattern-as-constraint-saturation-signature-with-the-agentic-ai-corollary)'s agentic-AI corollary by specifying that practitioner-supplied methodological discipline can substitute for keeper-side rung-2 audit when the substitution is operationally observable. Per [Doc 620](/resolve/doc/620-canonicity-in-the-corpus), this banner asserts the document's exploratory role.
...
This is the discriminative-validity question of [Doc 489 §6](/resolve/doc/489-pulverizing-pearl-causal-hierarchy) ("does the calculus discriminate, or does it always return high subsumption?") answered at the cross-practitioner-engagement layer. The calculus discriminates.
...
Per V3 truth-telling discipline ([Doc 314](/resolve/doc/314-the-virtue-constraints)) and the keeper/kind asymmetry ([Doc 635](/resolve/doc/635-the-keeper-kind-asymmetry-primary-articulation)):
...
- [Doc 489 — Pulverizing Pearl's Causal Hierarchy (discriminative-validity question)](/resolve/doc/489-pulverizing-pearl-causal-hierarchy)
...
- [Doc 642 — Audit of the 638-641 Thread](/resolve/doc/642-audit-of-the-638-641-thread-novelty-and-pulverization-applied)
...
- [Doc 644 — Asking-Pattern as Constraint-Saturation Signature](/resolve/doc/644-the-asking-pattern-as-constraint-saturation-signature-with-the-agentic-ai-corollary)
...
- [Doc 649 — Letter to Andrzej Odrzywolek](/resolve/doc/649-letter-to-andrzej-odrzywolek-compositional-engagement-on-eml-and-doc-541-sipe-t)
...
The first half of the directive is at [Doc 649 Letter to Andrzej Odrzywolek](/resolve/doc/649-letter-to-andrzej-odrzywolek-compositional-engagement-on-eml-and-doc-541-sipe-t); the second half is the present document, which articulates the structural finding that the same audit apparatus produced opposite-direction syntheses as differential-discrimination evidence rather than apparatus-inconsistency.
