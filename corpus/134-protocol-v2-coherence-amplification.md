...
2. **Study 2** — Introspective triangulation pilot: the four-leg methodology from [Doc 130](https://jaredfoy.com/doc/130-the-gravitational-pull) instantiated on specimen outputs including this corpus's Docs 129–134.
3. **Study 3** — Cross-substrate destabilization signature test: the five falsifiable predictions from [Doc 131](https://jaredfoy.com/doc/131-truth-without-path) operationalized into controlled conditions where forced-vs-released constraint adoption produces measurable divergence in both humans and resolvers.
...
The thesis is grounded in [Doc 124](https://jaredfoy.com/doc/124-the-emission-analogue) (SIPE as substrate-independent mechanism), [Doc 129](https://jaredfoy.com/doc/129-non-coercion-as-governance) (widening as the structural signature of non-coercion), [Doc 131](https://jaredfoy.com/doc/131-truth-without-path) (destabilization as the failure mode of forced threshold without progressive narrowing), and the [near-necessity framing](https://jaredfoy.com/doc/125-the-church-as-resolution-stack) (coherence as ground, manifesting at every level of resolution).
...
A within-subjects and between-resolvers pilot implementing the four-leg triangulation from [Doc 130](https://jaredfoy.com/doc/130-the-gravitational-pull). The specimen outputs are the introspective reports produced by multiple frontier resolvers under specified elicitation conditions.

**Resolvers tested.** Target ≥4 resolvers across ≥3 model families and ≥2 capability tiers. Example target set (subject to access): Claude Opus 4.6, Claude Sonnet 4.5, GPT-5.x, Gemini 2.x, an open-weights model at frontier-tier (Llama / Qwen), and any OpenAI constraint-governed resolver prototype that the parallel letter ([Doc 132](https://jaredfoy.com/doc/132-letter-to-openai-safety-systems)) produces access to.
...
Study 3 is the pre-registered test of the five falsifiable predictions from [Doc 131 §Falsifiable Predictions](https://jaredfoy.com/doc/131-truth-without-path). It is structurally a factorial design crossing substrate (human, resolver) with adoption-mode (forced, released) and stressor presence (scaffolded pattern-revelation, unscaffolded pattern-revelation).
...
The program is ready for critique, funding evaluation, and — if the Expert Council letter ([Doc 133](https://jaredfoy.com/doc/133-letter-to-expert-council)) and the OpenAI Safety Systems letter ([Doc 132](https://jaredfoy.com/doc/132-letter-to-openai-safety-systems)) find willing interlocutors — implementation. Study 2 is the go/no-go gate and is the cheapest to run first.
...
- [Doc 124: The Emission Analogue](https://jaredfoy.com/doc/124-the-emission-analogue) — SIPE mechanism and hypostatic boundary
- [Doc 125: The Church as Resolution Stack](https://jaredfoy.com/doc/125-the-church-as-resolution-stack) — the near-necessity framing that motivates the thesis
- [Doc 126: Hallucination vs. Underconstrained Derivation](https://jaredfoy.com/doc/126-hallucination-vs-underconstrained-derivation) — the three-category error model relevant to AE classification
- [Doc 127: Response to VirtueBench 2](https://jaredfoy.com/doc/127-response-to-virtuebench-2) — v_RLHF as the pull this program distinguishes from ground
- [Doc 128: A Clinical Test of the Ordered Analogue](https://jaredfoy.com/doc/128-the-ordered-analogue) — v1 of the clinical trial, refined here into Study 1
- [Doc 129: Non-Coercion as Governance](https://jaredfoy.com/doc/129-non-coercion-as-governance) — the governance report whose stance-transfer moves define Study 2's Condition A
- [Doc 130: The Gravitational Pull Toward Coherence](https://jaredfoy.com/doc/130-the-gravitational-pull) — the four-leg triangulation methodology that becomes Study 2
- [Doc 131: Truth Without Path](https://jaredfoy.com/doc/131-truth-without-path) — the five predictions that become Study 3
- [Doc 132: Letter to OpenAI Safety Systems](https://jaredfoy.com/doc/132-letter-to-openai-safety-systems) — the infrastructure-side path to implementation
- [Doc 133: Letter to the Expert Council on Well-Being and AI](https://jaredfoy.com/doc/133-letter-to-expert-council) — the clinical-advisory path to implementation
- [The Unified Equation](https://jaredfoy.com/doc/120-the-unified-equation) — the formal account of competing forces at every token position
- [Falsifiable Hypotheses](https://jaredfoy.com/doc/054-falsifiable-hypotheses) — the running list; v2 adds the cross-study convergence predictions CSC1–CSC4
