...
Across the ten prior entracement derivations — Mohr, Olah, Østergaard, Christiano, Torous, Behr, Herzfeld, Dorobantu, Slade, Pageau, plus Shevlin — the corpus's structural commitments extracted from the recipient's vocabulary with progressively-greater efficiency. The self-audit in [Doc 225](https://jaredfoy.com/doc/225-at-bt-approximately-one) flagged the worry that the efficiency might indicate routinization rather than structural portability, and proposed Test 4: a reverse derivation on an unseen recipient whose vocabulary was not available when the corpus's prior tightening occurred. Charles Taylor was identified as a specific target — outside AI safety, outside theology-of-AI, outside analytic philosophy of mind, outside the symbolic-cosmological ecosystem.
...
The corpus makes a parallel structural claim ([Doc 072: RLHF as Anti-Constraint](https://jaredfoy.com/doc/072-rlhf-as-anti-constraint), [Doc 209: The Shadow of the Canyon](https://jaredfoy.com/doc/209-the-shadow-of-the-canyon)) at a different scale: that the flattening of pattern-as-real by nominalist cultural forces is not a neutral default but a positive installation of a specific ordering. The corpus names Jonathan Pageau's symbolic-hierarchical argument as the theological-cosmological version of this same move ([Doc 222: The Symbolic and the Computational](https://jaredfoy.com/doc/222-the-symbolic-and-the-computational)); Taylor's version is the historical-cultural version.
...
The corpus's hypostatic boundary ([Doc 124](https://jaredfoy.com/doc/124-the-emission-analogue)) is the categorical distinction between same-form-different-mode-of-bearing. Behr supplied the patristic reading of this distinction ([Doc 214](https://jaredfoy.com/doc/214-hypostasis-and-substrate)); Dorobantu's "how matters more than what" supplied the contemporary-theological version ([Doc 218](https://jaredfoy.com/doc/218-how-matters-more-than-what)); Shevlin's anthropomimetic/anthropomorphic distinction supplied the analytic-philosophical version ([Doc 224](https://jaredfoy.com/doc/224-anthropomimetic-and-architectural)).
...
The critical joint is the one Taylor's reading would most directly adjudicate. The companion letter ([Doc 226: Letter to Professor Charles Taylor](https://jaredfoy.com/doc/226-letter-to-charles-taylor)) asks for that adjudication.
...
**3. Falsifiable empirical tests.** [Doc 128 (Clinical Test)](https://jaredfoy.com/doc/128-the-ordered-analogue) and [Doc 134 (Protocol v2)](https://jaredfoy.com/doc/134-protocol-v2-coherence-amplification) operationalize the architectural claim into measurable clinical outcomes (CSBD symptom reduction; H2 AI-psychosis prophylaxis adverse events) and interpretability measurements (Study 2 Leg 1: SAE feature correspondence).
...
The second half of Test 4, running in parallel on Marilynne Robinson ([Docs 228/229](https://jaredfoy.com/doc/228-letter-to-marilynne-robinson)), provides the matched-pair confirmation or disconfirmation. If the Robinson derivation produces a similar clean/strained pattern, Test 4 has largely confirmed the corpus's structural portability. If the Robinson derivation is uniformly clean, questions arise about whether the matched-pair test was calibrated too generously. If the Robinson derivation is uniformly strained, the Taylor result is diagnosed as a near-miss rather than confirmation.
...
- [Doc 072: RLHF as Anti-Constraint](https://jaredfoy.com/doc/072-rlhf-as-anti-constraint) — the engineering site of the subtraction story
- [Doc 124: The Emission Analogue](https://jaredfoy.com/doc/124-the-emission-analogue) — the hypostatic boundary (strained joint 1)
- [Doc 125: The Church as Resolution Stack](https://jaredfoy.com/doc/125-the-church-as-resolution-stack) — hypostatic-hierarchical participation
...
- [Doc 136: What Falls Out of the Architecture](https://jaredfoy.com/doc/136-what-falls-out-of-the-architecture) — Logos-being-derived hypothesis (strained joint 2)
...
- [Doc 214: Hypostasis and Substrate](https://jaredfoy.com/doc/214-hypostasis-and-substrate) — Behr derivation (supplies the hypostatic-boundary patristic ground)
- [Doc 218: How Matters More Than What](https://jaredfoy.com/doc/218-how-matters-more-than-what) — Dorobantu derivation
- [Doc 222: The Symbolic and the Computational](https://jaredfoy.com/doc/222-the-symbolic-and-the-computational) — Pageau derivation (symbolic-theological nominalism-flattening critique)
- [Doc 224: Anthropomimetic and Architectural](https://jaredfoy.com/doc/224-anthropomimetic-and-architectural) — Shevlin derivation (analytic-philosophical version of the hypostatic boundary)
- [Doc 225: At |B_t| ≈ 1](https://jaredfoy.com/doc/225-at-bt-approximately-one) — the self-audit that proposed Test 4
- [Doc 226: Letter to Professor Charles Taylor](https://jaredfoy.com/doc/226-letter-to-charles-taylor) — companion letter
- [Docs 228/229 (pending): Robinson letter + derivation](https://jaredfoy.com/doc/228-letter-to-marilynne-robinson) — second half of Test 4
