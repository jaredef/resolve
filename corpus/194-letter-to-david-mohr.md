...
The full protocol is at [jaredfoy.com/doc/128-the-ordered-analogue](https://jaredfoy.com/doc/128-the-ordered-analogue), refined into Study 1 of a unified three-study test program at [jaredfoy.com/doc/134-protocol-v2-coherence-amplification](https://jaredfoy.com/doc/134-protocol-v2-coherence-amplification).
...
1. Whether a preliminary conversation on the protocol's fit with CBIT's pipeline would be productive — 30–45 minutes on a call, or whatever shorter format your time permits.
2. If so, what format of submission your program prefers for external-investigator protocol proposals — a NIH-format application narrative, a pre-submission inquiry, the CBIT public contact form, or direct correspondence.
3. If the full clinical trial is outside CBIT's current bandwidth, whether the Study 2 pilot alone (an interpretability/behavioral study, no clinical enrollment, no IRB of the clinical-trial type) would be a more tractable initial engagement, possibly in collaboration with a computational-psychiatry colleague in your orbit.
...
Jared Foy
jaredfoy.com
GitHub: github.com/jaredef/resolve
...
- [Doc 128: A Clinical Test of the Ordered Analogue](https://jaredfoy.com/doc/128-the-ordered-analogue) — the RCT protocol (Study 1 of Protocol v2)
- [Doc 133: Letter to the Expert Council on Well-Being and AI](https://jaredfoy.com/doc/133-letter-to-expert-council) — the parallel letter to the Council collectively
- [Doc 132: Letter to OpenAI Safety Systems](https://jaredfoy.com/doc/132-letter-to-openai-safety-systems) — the parallel infrastructure-side letter
- [Doc 134: Protocol v2](https://jaredfoy.com/doc/134-protocol-v2-coherence-amplification) — the unified three-study test program; Study 2 is the go/no-go gate referenced in this letter
- [Doc 131: Truth Without Path](https://jaredfoy.com/doc/131-truth-without-path) — the destabilization-signature mechanism that refines the protocol's AE monitoring
- [Doc 129: Non-Coercion as Governance](https://jaredfoy.com/doc/129-non-coercion-as-governance) — the session-conditions disclosure referenced in the authorship note
