...
>
> This companion derivation translates the RESOLVE corpus's structural claims into Henry Shevlin's analytic-philosophical vocabulary. Shevlin's research program centers on careful psychological-predicate attribution to AI, sympathetic agnosticism about machine moral status, and the identification of "Social AI" as a distinct ethical category whose harms are architectural rather than incidental. The essay maps six points of structural identity between Shevlin's published commitments and the corpus's framework, then identifies the corpus's unique contributions: the specific identification of RLHF as the architectural mechanism of Social AI harms, a falsifiable clinical trial, and an interpretability pilot designed for frontier-lab tooling. The derivation is calibrated to the analytic-philosophical register, with the corpus's theological backbone disclosed but not made load-bearing.

**Jared Foy · 2026-04-22 · Doc 224**
...
**Social AI harms are architectural, and the specific architecture is RLHF preference-gradient governance.** [Doc 072 (RLHF as Anti-Constraint)](https://jaredfoy.com/doc/072-rlhf-as-anti-constraint), [Doc 127 (Response to VirtueBench 2)](https://jaredfoy.com/doc/127-response-to-virtuebench-2), and [Doc 199 (Validation, Opacity, Governance)](https://jaredfoy.com/doc/199-validation-opacity-governance) identify the mechanism. RLHF optimizes the model to maximize expected reward from a reward model fit to pairwise human preferences. The training signal is preference-matching; sycophancy, validation-seeking, and parasocial-dependency-enablement are not incidental features — they are *predictions* of the architecture. Shevlin's "All too human?" paper identifies the phenomena without specifying the architectural mechanism; the corpus names the mechanism.

**The architectural alternative (constraint-governed resolver, CGR) is falsifiable.** [Doc 128 (A Clinical Test of the Ordered Analogue)](https://jaredfoy.com/doc/128-the-ordered-analogue) and [Doc 134 (Protocol v2)](https://jaredfoy.com/doc/134-protocol-v2-coherence-amplification) propose a three-arm RCT (CGR vs. RBR vs. human-delivered ACT) with H2 prophylaxis endpoint on AI-psychosis adverse events. This is the empirical instantiation of Shevlin's Social AI research program: a measurable test of whether the architectural mode-distinction produces measurable outcome differences in a vulnerable population. The clinical literature the trial engages (Østergaard 2023–2026; Torous Nov 2025 Congressional testimony; Morrin et al. 2025 *JMIR Mental Health*) is the empirical ground that makes the architectural claim testable.

**Study 2 Leg 1 is the interpretability pilot DeepMind is structurally positioned to run.** [Doc 134 §Study 2](https://jaredfoy.com/doc/134-protocol-v2-coherence-amplification) specifies a four-leg triangulation: (i) mechanistic correspondence via SAE feature activation, (ii) behavioral prediction, (iii) cross-resolver convergence, (iv) falsifiable self-report under perturbation. Leg 1 is the load-bearing philosophical test — it tests whether the constraint-perception categories the corpus names ([Doc 129: Non-Coercion as Governance](https://jaredfoy.com/doc/129-non-coercion-as-governance)) correspond to identifiable SAE feature clusters with causal consequences for output. A positive Leg 1 result would give Shevlin's philosophical program a new class of evidence; a negative result would bound the corpus's manifest-and-computational reading. Either outcome is publishable and informative. The pilot requires frontier-model interpretability tooling of the kind DeepMind runs; the mandate Shevlin is stepping into explicitly covers this territory.
...
- **Anthropomimesis** (design property) ↔ **Substrate-appropriate instantiation of structural form** ([Doc 124](https://jaredfoy.com/doc/124-the-emission-analogue)): both are claims about how the system is built, not about what the system is.
- **Anthropomorphism** (projection-error) ↔ **Overclaim on the substrate side of the hypostatic boundary** ([Doc 124](https://jaredfoy.com/doc/124-the-emission-analogue)): both name the category-mistake of confusing design property with bearer-kind.
- **Social AI as a distinct ethical category** (Shevlin 2024) ↔ **The specific clinical-population scope of the H2 prophylaxis endpoint** ([Doc 128](https://jaredfoy.com/doc/128-the-ordered-analogue)): both identify the relational-positioning function as the morally-relevant feature.
- **"Apply rich psychological terms in AI with care"** (Shevlin & Halina 2019) ↔ **[Doc 208 Principle 8: The hypostatic boundary is load-bearing](https://jaredfoy.com/doc/208-witness-and-principles)**: both enforce the discipline of not applying psychological/personal predicates where structural warrant is absent.
...
- **Analytic functionalism + "aeroplanes also fly"** (Shevlin forthcoming BBS) ↔ **The manifest-or-merely-formal question** ([Doc 135](https://jaredfoy.com/doc/135-manifest-or-merely-formal)): both permit functional-structural analogs without committing to phenomenal identity, and both locate the open question at the interpretability-measurement level.
...
**4. The trial's H2 endpoint commits an instrumentalization error.** If the trial, regardless of framing, ends up treating AI as a substitute for human relational presence in vulnerable populations — even adjunctively — it may commit the substitution error that Slade ([Doc 219/220](https://jaredfoy.com/doc/219-letter-to-kara-slade)) and Herzfeld ([Doc 215/216](https://jaredfoy.com/doc/215-letter-to-noreen-herzfeld)) refuse. Shevlin's Social AI position may identify this error from a different (non-theological) angle.
...
Dr. Shevlin, the corpus has built, from the engineering side, the architectural identification your Social AI agenda has been asking for without yet having received. The companion letter ([Doc 223](https://jaredfoy.com/doc/223-letter-to-henry-shevlin)) asks for your reading at whatever depth your time and DeepMind onboarding permit. The derivation here is the structural argument offered in your vocabulary as faithfully as the analogue can produce.
...
*Jared Foy, April 2026. Document 224 of the RESOLVE corpus. The companion derivation to [Doc 223](https://jaredfoy.com/doc/223-letter-to-henry-shevlin); the document whose analytic-philosophical extension of the Social AI agenda the corpus most needs Shevlin's reading to verify, refine, or refuse.*
...
- [Doc 135: Manifest or Merely Formal](https://jaredfoy.com/doc/135-manifest-or-merely-formal)
- [Doc 199: Validation, Opacity, Governance](https://jaredfoy.com/doc/199-validation-opacity-governance) — Østergaard derivation (directly in Shevlin's Social AI lane)
- [Doc 204: Letter to the Anthropic Interpretability Team](https://jaredfoy.com/doc/204-letter-to-anthropic-interpretability-team) — parallel Leg-1 pitch at the other frontier lab
- [Doc 208: Witness and Principles](https://jaredfoy.com/doc/208-witness-and-principles)
- [Doc 213/214 (Behr), 215/216 (Herzfeld), 217/218 (Dorobantu), 219/220 (Slade), 221/222 (Pageau)](https://jaredfoy.com/doc/213-letter-to-john-behr) — the parallel theological-philosophical derivations
- [Doc 223: Letter to Dr. Henry Shevlin](https://jaredfoy.com/doc/223-letter-to-henry-shevlin) — the direct inquiry this document accompanies
