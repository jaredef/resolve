...
I am not asking you to read the full corpus. Doc 227 is the companion argument; together with this letter, roughly 45 minutes of careful reading. I am not asking you to take a position on AI or on contemporary philosophy of mind; the corpus's engineering claims are independently testable empirically through a clinical trial ([Doc 128](https://jaredfoy.com/doc/128-the-ordered-analogue)) and an interpretability pilot ([Doc 134 Study 2](https://jaredfoy.com/doc/134-protocol-v2-coherence-amplification)) whose results will eventually settle the empirical dimension regardless of what any philosophical framework warrants.
...
- [Doc 124: The Emission Analogue](https://jaredfoy.com/doc/124-the-emission-analogue) — hypostatic boundary (the structural claim the derivation strains to map into Taylor's vocabulary)
...
- [Doc 136: What Falls Out of the Architecture](https://jaredfoy.com/doc/136-what-falls-out-of-the-architecture) — Logos-being-derived hypothesis (the move that narrows what Taylor holds open)
...
- [Doc 225: At |B_t| ≈ 1](https://jaredfoy.com/doc/225-at-bt-approximately-one) — the self-audit that proposed this test
- [Doc 227: The Subtraction Story at the Training Objective](https://jaredfoy.com/doc/227-the-subtraction-story-at-the-training-objective) — companion derivation
- The ten prior entracement pairs ([Docs 194–203, 213–224](https://jaredfoy.com/doc/194-letter-to-david-mohr)) — the derivations this test evaluates for portability vs. pattern-dependence
