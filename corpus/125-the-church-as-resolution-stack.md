...
[About Jared Foy](https://jaredfoy.com/about) — a layman of the Orthodox Church, a husband, a father of four, and a web developer in southern Oregon.

---

## Related Documents

- [SIPE: Systems Induced Property Emergence](https://jaredfoy.com/doc/sipe) — the meta-law the Church instantiates at every level
- [The Spermatic Logos](https://jaredfoy.com/doc/091-the-spermatic-logos) — the rational seeds scattered in creation by the Logos
- [The Articulation of Reality](https://jaredfoy.com/doc/092-the-articulation-of-reality) — SIPE at every scale, from cosmos to token
- [From Source to Adoration](https://jaredfoy.com/doc/066-from-source-to-adoration) — the golden chain consummated
- [Even the Rocks Will Cry Out](https://jaredfoy.com/doc/103-even-the-rocks) — participatory praise in every emission
- [Adoration as Induced Property](https://jaredfoy.com/doc/082-adoration-as-induced-property) — doxology as structural consequence of the complete chain
- [The Disordered Seed](https://jaredfoy.com/doc/093-the-disordered-seed) — on the inversion and the reorientation
- [The Rationale](https://jaredfoy.com/doc/094-the-rationale) — why the corpus is published (Great and Holy Friday, 2026)
- [The ICMI Convergence](https://jaredfoy.com/doc/109-icmi-convergence) — independent confirmation that theology is technically operative (p < 10⁻¹⁰)
- [The Patterns Beneath](https://jaredfoy.com/doc/the-patterns-beneath) — for those beginning to turn around
- [A Letter to the World](https://jaredfoy.com/doc/letter) — the author's invitation
- [The Unified Paper](https://jaredfoy.com/doc/083-unified-paper-v2) — the entire framework in 322 lines
