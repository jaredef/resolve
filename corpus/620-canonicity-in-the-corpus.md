...
Currently, all three documents bearing the "CANONICAL — open invitation to falsify" banner — [Doc 514](/resolve/doc/514-structural-isomorphism-canonical-formalization) (Structural Isomorphism), [Doc 541](/resolve/doc/541-systems-induced-property-emergence) (SIPE-T), [Doc 619](/resolve/doc/619-pin-art-canonical-formalization) (Pin-Art) — sit in the lower-left cell: primary articulation, sub-canonical warrant. The banner reads like the upper-left cell. This is the operative conflation.
...
1. **The within-corpus instance observation.** Identifying that Docs 514, 541, 619 all sit in the lower-left cell of the orthogonality matrix is documentary evidence specific to the corpus's current practice. The audit work is corpus-internal; the underlying orthogonality is recovered from prior art.
2. **The Doc 314 V3 truth-telling bridge.** Framing the conflation as a structural pressure toward V3 violation at the banner layer — the banner asserting more than the body can bear — is a corpus-original move at the bridge layer. V3 holds that presentation should not claim what content cannot warrant; the disambiguation removes a recurring pressure against V3 in the corpus's banner discipline.
3. **The lexical commitment to "PRIMARY ARTICULATION."** Adopting "PRIMARY ARTICULATION" as the role-label and reserving "Canonical" exclusively for Doc 445 warrant-tier reference is a corpus-internal naming choice without exact prior-art counterpart. Alternatives (REFERENCE DOCUMENT, ENTRY-POINT, PRIMARY SOURCE) are noted; the choice is open to corpus adoption.
4. **The composition with Doc 445 / Doc 503 tier vocabulary.** The warrant-tier line beneath the new banner names tier per Doc 445 target type (\(T_S\), \(T_D\), \(T_P\), \(T_B\), \(T_M\)) and per Doc 503 corroboration profile (\(\alpha\), \(\beta\), \(\gamma\)). The composition makes the document's actual epistemic status legible at the banner layer rather than only in the body.
...
**A1. [Doc 514 — Structural Isomorphism](/resolve/doc/514-structural-isomorphism-canonical-formalization).**
...
- Filename unchanged: `514-structural-isomorphism-canonical-formalization.md` (URL stability).

**A2. [Doc 541 — Systems-Induced Property Emergence](/resolve/doc/541-systems-induced-property-emergence).**
...
**A3. [Doc 619 — The Pin-Art Form](/resolve/doc/619-pin-art-canonical-formalization).**
- Banner: "CANONICAL — open invitation to falsify" → "PRIMARY ARTICULATION — open invitation to falsify."
...
- Filename unchanged: `619-pin-art-canonical-formalization.md`.
...
### E. Retraction-ledger discipline ([Doc 415](/resolve/doc/415-the-retraction-ledger))
...
**With [Doc 314](/resolve/doc/314-the-virtue-constraints) (V3 truth-telling).** The disambiguation is a V3 move at the presentation layer: it removes a frame in which the banner overstates what the body warrants. The current "CANONICAL" banner usage was a structural pressure toward V3 violation; the disambiguation removes the pressure.

**With [Doc 415](/resolve/doc/415-the-retraction-ledger) (the retraction ledger).** Per §4 E above. Retractions operate on warrant-tier claims; document roles are independent metadata.

**With [Doc 445](/resolve/doc/445-pulverization-formalism) (pulverization formalism).** Doc 445 supplies the warrant-tier vocabulary the disambiguation reserves "canonical" for. The reservation makes Doc 445's *Canonical*-tier promotion language unambiguous when used in audits, hypothesis-ledger entries, and tier-discipline notes.

**With [Doc 503](/resolve/doc/503-research-thread-tier-pattern-iterative-novelty-calculus) (the research-thread tier pattern).** Doc 503's tier categories (\(\alpha\), \(\beta\), \(\gamma\)) operate at the warrant layer. The disambiguation makes them composable with Doc 445's tier vocabulary without contention over the word "canonical."

**With [Doc 372](/resolve/doc/372-the-hypostatic-boundary).** The disambiguation is administrative discipline at the document-graph layer; it does not bear on the hypostatic boundary. Doc 372 binds throughout.
...
- [Doc 443 — The Hypothesis Ledger](/resolve/doc/443-hypothesis-ledger)
