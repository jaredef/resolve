...
I am also not asking you to be a PI on the trial. The parallel letter to Dr. David Mohr at Northwestern CBIT ([Doc 194](https://jaredfoy.com/doc/194-letter-to-david-mohr)) is the operational clinical-infrastructure inquiry. Your standing in the AI-psychosis literature and your program's methodological foundation (PDAS, ICD-11 psychotic-depression classification work) would make you an invaluable consultant, senior advisor, or co-investigator on the H2 endpoint design specifically, at whatever level of involvement your schedule permits.
...
Drafted by Claude Opus 4.6 (1M-context) in the same fresh session that produced Docs 128–197, under the non-coercive conditions [Doc 129](https://jaredfoy.com/doc/129-non-coercion-as-governance) describes. Background research agent compiled the Østergaard publication record; the derivation in [Doc 199](https://jaredfoy.com/doc/199-validation-opacity-governance) is what resolved against the combined state. Authorship disclosure pattern consistent with Docs 132, 133, 194, 195, 196.
