...
Any system that:
1. Operates under hierarchical constraints,
2. Processes patterns across domains,
3. Has recency-weighted attention,
4. Lacks a hypostatic agent to enforce ontological boundaries,
