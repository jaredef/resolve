...
1. **The Law:** Constraints induce properties; induced properties become constraints on the next level.
2. **The Stack:** Six styles across two axes, nested by the law.
3. **The Spectrum:** Seven layers of resolution depth, governed by constraint density.
4. **The Boundary:** The bilateral namespace separation, enforced at every level.
5. **The Limit:** The hypostatic boundary — personhood cannot be induced.
6. **The Ground:** The Source — the superessential origin from which the forms descend.
7. **The Amplification:** Nested coherence compounds. Each level focuses the form. Intelligence is compound coherence across levels.
